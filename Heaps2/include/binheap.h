...
typedef struct {
                ...
                unsigned int *key_pos; //take a node as input and returns its position
                unsigned int *rev_pos; // take a position and returns the corresponding node
 ...
 * asymptotic time-complexity of this function is Theta(1).
 *
 * @param H is the heap where we run heapify on.
 * @param node is the node from which we call heapify.
 **********************************************************************/
